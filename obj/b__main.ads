...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#ba4c44c4#;
   ...
   u00102 : constant Version_32 := 16#89410887#;
   pragma Export (C, u00102, "ada__calendar__formattingB");
   u00103 : constant Version_32 := 16#a2aff7a7#;
   pragma Export (C, u00103, "ada__calendar__formattingS");
   u00104 : constant Version_32 := 16#974d849e#;
   pragma Export (C, u00104, "ada__calendar__time_zonesB");
   u00105 : constant Version_32 := 16#ade8f076#;
   pragma Export (C, u00105, "ada__calendar__time_zonesS");
   u00106 : constant Version_32 := 16#f6b440a2#;
   pragma Export (C, u00106, "system__val_fixed_64S");
   u00107 : constant Version_32 := 16#ae4beccb#;
   pragma Export (C, u00107, "system__val_intS");
   u00108 : constant Version_32 := 16#a5b55d2f#;
   pragma Export (C, u00108, "system__val_unsS");
   u00109 : constant Version_32 := 16#f2c63a02#;
   pragma Export (C, u00109, "ada__numericsS");
   u00110 : constant Version_32 := 16#91809229#;
   pragma Export (C, u00110, "ada__real_timeB");
   u00111 : constant Version_32 := 16#1ad7dfc0#;
   pragma Export (C, u00111, "ada__real_timeS");
   u00112 : constant Version_32 := 16#96c62183#;
   pragma Export (C, u00112, "system__taskingB");
   u00113 : constant Version_32 := 16#256a579d#;
   pragma Export (C, u00113, "system__taskingS");
   u00114 : constant Version_32 := 16#0c334715#;
   pragma Export (C, u00114, "system__task_primitivesS");
   u00115 : constant Version_32 := 16#4e3ebb7e#;
   pragma Export (C, u00115, "system__os_interfaceS");
   u00116 : constant Version_32 := 16#0039537b#;
   pragma Export (C, u00116, "interfaces__c__stringsB");
   u00117 : constant Version_32 := 16#eda3d306#;
   pragma Export (C, u00117, "interfaces__c__stringsS");
   u00118 : constant Version_32 := 16#cc709166#;
   pragma Export (C, u00118, "system__task_primitives__operationsB");
   u00119 : constant Version_32 := 16#9723968e#;
   pragma Export (C, u00119, "system__task_primitives__operationsS");
   u00120 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00120, "system__float_controlB");
   u00121 : constant Version_32 := 16#cf061228#;
   pragma Export (C, u00121, "system__float_controlS");
   u00122 : constant Version_32 := 16#6387a759#;
   pragma Export (C, u00122, "system__interrupt_managementB");
   u00123 : constant Version_32 := 16#26aedc33#;
   pragma Export (C, u00123, "system__interrupt_managementS");
   u00124 : constant Version_32 := 16#7bca5a8d#;
   pragma Export (C, u00124, "system__multiprocessorsB");
   u00125 : constant Version_32 := 16#1756ce67#;
   pragma Export (C, u00125, "system__multiprocessorsS");
   u00126 : constant Version_32 := 16#ce7dfb56#;
   pragma Export (C, u00126, "system__task_infoB");
   u00127 : constant Version_32 := 16#5a49699d#;
   pragma Export (C, u00127, "system__task_infoS");
   u00128 : constant Version_32 := 16#4ddebf0b#;
   pragma Export (C, u00128, "system__tasking__debugB");
   u00129 : constant Version_32 := 16#d3b35c55#;
   ...
   u00134 : constant Version_32 := 16#617d5887#;
   pragma Export (C, u00134, "system__stack_usageB");
   u00135 : constant Version_32 := 16#8d63b971#;
   pragma Export (C, u00135, "system__stack_usageS");
   u00136 : constant Version_32 := 16#97d7e40a#;
   pragma Export (C, u00136, "ada__real_time__delaysB");
   u00137 : constant Version_32 := 16#0a5c26d7#;
   pragma Export (C, u00137, "ada__real_time__delaysS");
   u00138 : constant Version_32 := 16#64cdbdac#;
   pragma Export (C, u00138, "ada__real_time__timing_eventsB");
   u00139 : constant Version_32 := 16#9ffc262b#;
   pragma Export (C, u00139, "ada__real_time__timing_eventsS");
   u00140 : constant Version_32 := 16#de53e0a3#;
   pragma Export (C, u00140, "ada__containers__helpersB");
   u00141 : constant Version_32 := 16#4adfc5eb#;
   ...
   u00145 : constant Version_32 := 16#8c178268#;
   pragma Export (C, u00145, "ada__strings__text_buffersB");
   u00146 : constant Version_32 := 16#0800bb5e#;
   pragma Export (C, u00146, "ada__strings__text_buffersS");
   u00147 : constant Version_32 := 16#cd3494c7#;
   pragma Export (C, u00147, "ada__strings__utf_encodingB");
   u00148 : constant Version_32 := 16#37e3917d#;
   pragma Export (C, u00148, "ada__strings__utf_encodingS");
   u00149 : constant Version_32 := 16#d1d1ed0b#;
   pragma Export (C, u00149, "ada__strings__utf_encoding__wide_stringsB");
   u00150 : constant Version_32 := 16#103ad78c#;
   ...
   u00152 : constant Version_32 := 16#91eda35b#;
   pragma Export (C, u00152, "ada__strings__utf_encoding__wide_wide_stringsS");
   u00153 : constant Version_32 := 16#b3f0dfa6#;
   pragma Export (C, u00153, "ada__tagsB");
   u00154 : constant Version_32 := 16#cb8ac80c#;
   pragma Export (C, u00154, "ada__tagsS");
   u00155 : constant Version_32 := 16#5534feb6#;
   pragma Export (C, u00155, "system__htableB");
   u00156 : constant Version_32 := 16#ab38e2fe#;
   pragma Export (C, u00156, "system__htableS");
   u00157 : constant Version_32 := 16#089f5cd0#;
   pragma Export (C, u00157, "system__string_hashB");
   u00158 : constant Version_32 := 16#09668980#;
   pragma Export (C, u00158, "system__string_hashS");
   u00159 : constant Version_32 := 16#5fc04ee2#;
   pragma Export (C, u00159, "system__put_imagesB");
   u00160 : constant Version_32 := 16#52d4e162#;
   pragma Export (C, u00160, "system__put_imagesS");
   u00161 : constant Version_32 := 16#e264263f#;
   pragma Export (C, u00161, "ada__strings__text_buffers__utilsB");
   u00162 : constant Version_32 := 16#608bd105#;
   pragma Export (C, u00162, "ada__strings__text_buffers__utilsS");
   ...
   u00171 : constant Version_32 := 16#0110e3c6#;
   pragma Export (C, u00171, "system__interrupt_management__operationsB");
   u00172 : constant Version_32 := 16#19b909c9#;
   pragma Export (C, u00172, "system__interrupt_management__operationsS");
   ...
   u00192 : constant Version_32 := 16#3880736e#;
   pragma Export (C, u00192, "ada__exceptions__is_null_occurrenceB");
   u00193 : constant Version_32 := 16#5ca174ae#;
   ...
   u00208 : constant Version_32 := 16#acbd1abf#;
   pragma Export (C, u00208, "system__tasking__utilitiesB");
   u00209 : constant Version_32 := 16#6b757be7#;
   pragma Export (C, u00209, "system__tasking__utilitiesS");
   u00210 : constant Version_32 := 16#d8bb58e0#;
   pragma Export (C, u00210, "ada__text_ioB");
   u00211 : constant Version_32 := 16#1eb2ee39#;
   pragma Export (C, u00211, "ada__text_ioS");
   u00212 : constant Version_32 := 16#73d2d764#;
   pragma Export (C, u00212, "interfaces__c_streamsB");
   u00213 : constant Version_32 := 16#066a78a0#;
   pragma Export (C, u00213, "interfaces__c_streamsS");
   u00214 : constant Version_32 := 16#30f1a29e#;
   pragma Export (C, u00214, "system__file_ioB");
   u00215 : constant Version_32 := 16#888bb071#;
   pragma Export (C, u00215, "system__file_ioS");
   u00216 : constant Version_32 := 16#d265cbbc#;
   pragma Export (C, u00216, "system__file_control_blockS");
   u00217 : constant Version_32 := 16#ff39dee5#;
   pragma Export (C, u00217, "compuerta_pB");
   u00218 : constant Version_32 := 16#0fc90f12#;
   pragma Export (C, u00218, "compuerta_pS");
   u00219 : constant Version_32 := 16#16d15950#;
   pragma Export (C, u00219, "reactor_pB");
   u00220 : constant Version_32 := 16#f6b34371#;
   pragma Export (C, u00220, "reactor_pS");
   u00221 : constant Version_32 := 16#8f461df5#;
   pragma Export (C, u00221, "text_ioS");
   u00222 : constant Version_32 := 16#53e436ea#;
   pragma Export (C, u00222, "muestreo_pB");
   u00223 : constant Version_32 := 16#61f514df#;
   pragma Export (C, u00223, "muestreo_pS");
   u00224 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00224, "system__concat_4B");
   u00225 : constant Version_32 := 16#519e7a34#;
   pragma Export (C, u00225, "system__concat_4S");
   u00226 : constant Version_32 := 16#0774605b#;
   pragma Export (C, u00226, "system__random_numbersB");
   u00227 : constant Version_32 := 16#19a1600c#;
   ...
   u00229 : constant Version_32 := 16#c3b30278#;
   pragma Export (C, u00229, "system__random_seedS");
   u00230 : constant Version_32 := 16#d7197b3e#;
   pragma Export (C, u00230, "system__tasking__async_delaysB");
   u00231 : constant Version_32 := 16#cadda972#;
   pragma Export (C, u00231, "system__tasking__async_delaysS");
   u00232 : constant Version_32 := 16#9b0368c5#;
   pragma Export (C, u00232, "ada__task_identificationB");
   u00233 : constant Version_32 := 16#d19ac6ee#;
   pragma Export (C, u00233, "ada__task_identificationS");
   u00234 : constant Version_32 := 16#eca5ecae#;
   pragma Export (C, u00234, "system__memoryB");
   u00235 : constant Version_32 := 16#76873720#;
